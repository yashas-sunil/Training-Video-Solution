...
class EaseBuzz
{
    ...
    */
    ...
    //    EaseBuzzPayment::initiate_payment($params, 'O00WZ3CMQ8', 'VFYSEPCN69', 'test');
       EaseBuzzPayment::initiate_payment($params,$this->MERCHANT_KEY,$this->SALT,$this->ENV);
    }
    ...
    */
    public function easebuzzResponse($params){
        ...
        $result = EaseBuzzPayment::response($params, $this->SALT);
