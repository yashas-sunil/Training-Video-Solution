...
@endif
<marquee class="bg-light py-2 font-weight-bold d-block marque" behavior="smooth" direction=""><a href="{{ url('/cafc-scholarship') }}" target="_blank">CA Foundation Scholarship by JKSC & THANE VAIBHAV. Click here for details.</a></marquee>
<nav class="navbar navbar-expand-lg navbar-top" data-aos="fade-down">
    <div class="upper_row">
    <a class="navbar-brand" href="/"><img src="{{ asset('assets/new_ui_assets/images/logo.png') }}" alt=""></a>
    ...
    {{--<div class="collapse navbar-collapse" id="navbarScroll">--}}
        <ul class="navbar-nav my-lg-0 navbar-nav-scroll" id="collappsed" style="max-height: 100px;">
            @if(! isset($user['role']) || (isset($user['role']) && $user['role'] != 6))
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ca-faculty.index') }}">Professors</a>
                </li>
                <li class="nav-item">
        ...
        <form class="d-flexing" id="collappsed_form">
            ...
            @if (!$user)
                ...
                <a href="" data-toggle="modal" data-target="#modal-signup" class="signup">Signup</a>
            @else
{{--                <li class="nav-item dropdown">--}}
    ...
    <div class="login-modal" id="login-modal">
        ...
        <form class="login-container" method="POST" action="{{ url('/login') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" placeholder="Email Id" class="{{ old('form') == 'login' && $errors->has('email') ? ' is-invalid' : '' }}"
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 p-0 md-d-none">
                        <div class="sign-up-image">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <h6 class="mb-0 font-weight-bold">Exisiting User?</h6>
                            ...
                            <div class="s-content">
                                ...
                                <div id="step-one">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <select class="form-control" id="mobile-code" name="mobile_code">
