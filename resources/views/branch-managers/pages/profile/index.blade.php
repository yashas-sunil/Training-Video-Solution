                        ...
                        <div class="col-md-5">
                            <ul class="list-group align-items-left">
                                <li class="list-group-item bg-transparent border-0 pl-0">
                                    <i class="fas fa-envelope mx-2 pr-3"></i>{{ $profile['email'] }}
                                </li>
                                <li class="list-group-item bg-transparent border-0 pl-0">
                                    <i class="fas fa-phone mx-2 pr-3 "></i>{{ $profile['phone'] }}
                                </li>
                            </ul>
        ...
        <div class="modal-dialog modal-change-password" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-change-password" method="POST" action="{{ route('branch-managers.profile.update', $profile['id']) }}">
                        @csrf
                        @method('PUT')
