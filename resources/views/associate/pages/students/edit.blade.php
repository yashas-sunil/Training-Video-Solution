        ...
        <div class="container-fluid py-4 px-5">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mt-md-0">
                        <form id="form-create-student" method="POST" action="{{ route('associate.students.update', $student['id']) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control form-control-sm input-sm" id="name" name="name" value="{{ $student['name'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="email" class="form-control form-control-sm" id="email" name="email" value="{{ $student['email'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <select id="student_mobile_code" class="form-control-sm bg-white mobile_code" name="mobile_code">
                                                <option value="+91" @if ($student['country_code'] == '+91') selected @endif>+91</option>
                                                <option value="+971" @if ($student['country_code'] == '+971') selected @endif>+971</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control form-control-sm phone {{$errors->has('phone') ? ' is-invalid' : '' }}" id="student_phone" name="phone" value="{{ $student['phone'] }}">
                                            @if ($errors->has('phone'))
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <x-inputs.course id="course-id" name="course_id" class="form-control form-control-sm" value="Hello">
                                                @if ($student['course'])
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control form-control-sm" id="city" name="city" value="{{ $student['addresses'][0]['city'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control form-control-sm" id="pin" name="pin" value="{{ $student['addresses'][0]['pin'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control form-control-sm" id="address" name="address" value="{{ $student['addresses'][0]['address'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control form-control-sm" id="area" name="area" value="{{ $student['addresses'][0]['area'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control form-control-sm" id="landmark" name="landmark" value="{{ $student['addresses'][0]['landmark'] }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
