        ...
        <div class="page-wrapper chiller-theme toggled" id="dashboard_sidebar">
            ...
            <main class="page-content">
                <div class="container-fluid" id="main_dashboard">
                    <div class="study_plans">
                        <div class="plan_title">
                            <div class="plan">Study plans</div>
                        </div>
                        <form id="filter_study_materials" action="" method="GET" >
                            <div class="select_options">
                                ...
                                <a href="{{ url('study-plans') }}" class="btn btn-primary">Clear</a>

{{--                                <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i></button>--}}
{{--                                <a href="{{url('study-plans')}}"><button type="reset" class="btn btn-primary">Clear</button></a>--}}
                            </div>
                        </form>
                        <div class="plan_list">
