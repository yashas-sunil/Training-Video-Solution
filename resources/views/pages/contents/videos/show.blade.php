...
{{--                            <script type='text/javascript' src='{{ $video['demo_player_url'] }}'></script>--}}
                        ...
                        <div class="mt-3">
                            ...
                            <div class="text-right">
                                <a href="{{ url('/packages?course=' . $video['course_id'] . '&level=' . $video['level_id'] . '&subject=' . $video['subject_id'] . '') }}" class="btn btn-primary">Explore for Buy</a>
                            </div>
                        </div>
                    @else
                                                ...
                                                @if ($chapter['videos'])
                                                    <div class="card mt-2 border-0 rounded">
                                                        ...
                                                        <div id="collapse{{ $chapter['id'] }}" class="collapse" aria-labelledby="heading{{ $chapter['id'] }}" data-parent="#student-chapters-accordion">
                                                            @foreach($chapterVideos as $chapterVideo)
                                                                <div class="border p-2 my-2">
                                                                    <div class="row">
                                                                        <div class="col-md-12 py-2">
                                                                            <a class="text-info video-link" href="#" data-video-id="{{ $chapterVideo['id'] }}" data-video-title="{{ $chapterVideo['title'] }}">{{ $chapterVideo['title'] }}</a>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                        <span class="text-muted fs-14">
                                                                            <i class="far fa-clock pr-1"></i> {{ $chapterVideo['formatted_duration'] }}
                                                                        </span>
                                                                        </div>
                                                                        <div class="col-md-8">
                                                                            <div class="progress">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            {{--                        <div class="form-group">--}}
                            {{--                            <label for="question-description" class="col-form-label">Detailed Question</label>--}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mt-2">
                        ...
                        <a href="{{ url('/packages?course=' . $video['course_id'] . '&level=' . $video['level_id'] . '&subject=' . $video['subject_id'] . '') }}" class="btn btn-block btn-primary">Explore for Buy</a>
                    </div>
                </div>
            </div>
        </div>
...
@push('script')
    ...
    <script>
        $(function() {
            ...
            function postVideoHistory(i, videoID) {
                $.ajax({
