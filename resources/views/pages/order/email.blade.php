            ...
            <table width="70" align="center" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                    <td height="70" style="padding: 0 20px 20px 0;">
                        <img class="fix" src="{{ $attributes['logo'] }}" width="150" border="0" alt="">
                    </td>
                </tr>
                </tbody></table>
        </td>
    ...
    <tr>
        <form method="post" >
            ...
            <td class="innerpadding borderbottom" style="padding-top: 0px;">
                ...
                <br />
                <br />
                <a href="{{ $attributes['url'] }}" >PURCHASE NOW</a>
                <input type="button" style="background-color: #f58457; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;" >
                <br />
                <br />
            </td>
        </form>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody><tr>
                    <td align="center" class="footercopy">
                        © 2020 JKSHAH ONLINE, All rights reserved.
                    </td>
                </tr>
                <tr>
