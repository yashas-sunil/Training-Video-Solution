...
@section('content')
    <main class="static-pages" role="main">
    <div class="contact-info">
            <h1>Privacy Policy</h1>
        </div>
        <div class="container-fluid py-4 px-lg-5">
            <!-- <h1 class="text-secondary"><b>Privacy Policy</b></h1> -->
          <!--   <div class="row mt-3">
                <div class="col-md-auto">

                    <div class="static-page-container border shadow text-center">
                        <div class="list-group my-4 ">
                            <a href="{{url('terms')}}" class="list-group-item text-primary border-0 list-group-item-action ">
                                Terms of Use
                            </a>
                            <a href="{{url('privacy')}}" class="list-group-item text-secondary border-0 list-group-item-action">
                                Privacy policy
                            </a>
                            {{--<a href="#" class="list-group-item text-secondary border-0 list-group-item-action ">Master Service Policy</a>--}}
                            {{--<a href="#" class="list-group-item text-secondary border-0 list-group-item-action "> Intellectual Property Policy</a>--}}
                            {{--<a href="#" class="list-group-item text-secondary border-0 list-group-item-action "> API Policy</a>--}}
                ...
                <div class="container">
                    ...
                    <a href="{{url('terms')}}" class="border-0">
                    <button class="priv-terms-btn"> Terms of Use
                            </button></a>
                    <a href="{{url('privacy')}}" class="border-0">
                    <button class="privacy-btn">   Privacy policy
                           </button> </a>
                    </div>
                <div class="col-md">
                    <div class="mt-4 mt-md-0">
                        <div class="m-auto">
                            <h5>Last Updated: August 22, 2020</h5>
                           <p>This Privacy Policy (“Privacy Policy/Policy”) discloses the privacy practices for JK Shah Classes Private Limited (“JKSC” or “ us” or “we” or “our” or “Company”) with regard to Your (“You/you” or “Your/your”) use of the online platform online.jkshahclasses.com  (“Website”). This Privacy Policy along with Terms of Use describes our practices regarding, including your choices in relation to how we collect, store, use, share and secure your personal information across our Website. It also describes your choices regarding use, access and correction of your personal information and your rights in relation to your personal information and how to contact us or supervisory authorities in the event you have a complaint.</p>
                            ...
                            <p> The user full name and his/her display picture can be publicly displayed on the Website. Depending on what profile and what services they are seeking, JKSC can ask for more information relating to address, billing information, certificates, past employment information etc.<p>
                            <p> JKSC can use technologies such as cookies, clear gifs, log files, and flash cookies for several purposes, including to help understand how you interact with our site and services, in order to provide a better experience.<p>

                            <h5>USAGE AND RETENTION OF INFORMATION</h5>
                               <p>We use the personal information we collect, including your Personal Data where it is necessary to deliver the services you have requested, where it is necessary to exercise or comply with legal rights or obligations or for normal business purposes of the kind set out in this Policy.</p></p>
                            ...
                            <h5> COMMUNITY</h5>
                            <p>JKSC is a community. We offer several features that allow members to connect and communicate in public or semi-public spaces, such as Forums and Teams. Please be sensibile and judge before posting in these community spaces or sharing your personal information with others on JKSC. Be aware that any personal information you submit there can be read, collected, or used by others, or could be used to send you unsolicited messages.</p>

                            <h5>SHARING AND DISCLOSING PERSONAL INFORMATION</h5>
                            ...
                            <h5> Keeping your Personal Data secure</h5>
                            ...
                            <p> The Site contains copyrighted material, trademarks and other proprietary information, including, but not limited to, text, software, photos, video, graphics, music, sound, and the entire contents of JKSC is protected by copyright as a collective work under the applicable copyright laws. JKSC owns a copyright in the selection, coordination, arrangement and enhancement of such content, as well as copyright or license to use in the content original to it. You may not modify, publish, transmit, participate in the transfer or sale, create derivative works, or in any way exploit, any of the content, in whole or in part. You may download / print / save copyrighted material for your personal use only. Except as otherwise expressly stated under copyright law, no copying, redistribution, retransmission, publication or commercial exploitation of downloaded material without the express permission of JKSC is permitted. If copying, redistribution or publication of copyrighted material is expressly permitted by JKSC, then no changes in or deletion of author attribution, trademark legend or copyright notice shall be made.</p>
                            <p> You acknowledge that you do not acquire any ownership rights by downloading copyrighted material. Trademarks that are located within or on our Website or a website otherwise owned or operated in conjunction with JKSC shall not be deemed to be in the public domain but rather the exclusive property of JKSC, unless such site is under license from the trademark owner thereof in which case such license is for the exclusive benefit and use of JKSC, unless otherwise stated.</p>
                            <p> JKSC does not have any express burden or responsibility to provide you with indications, markings or anything else that may aid you in determining whether the material in question is copyrighted or trademarked. You shall be solely liable for any damage resulting from any infringement of copyrights, trademarks, proprietary rights or any other harm resulting from such a submission. By submitting material to any public area of the Website, you warrant that the owner of such material has expressly granted JKSC the royalty-free, perpetual, irrevocable, non-exclusive right and license to use, reproduce, modify, adapt, publish, translate and distribute such material (in whole or in part) worldwide and/or to incorporate it in other works in any form, media or technology now known or hereafter developed for the full term of any copyright that may exist in such material. You also permit any other end user to access, view, store or reproduce the material for that end user's personal use. You hereby grant JKSC, the right to edit, copy, publish and distribute any material made available on the Website by you.</p>
                            <p> If you come across any abuse or violation of these Terms, please report to helpdesk@jkshahclasses.com.</p>
                             ...
                             <p>  In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below:
                                helpdesk@jkshahclasses.com</p>

                             <h5> CONSENT TO THIS POLICY<h5>
                            <p> The Terms of Use Agreement is incorporated herein by reference in its entirety.</p>

                            <h5>GENERAL</h5>
                            <p> Modification: We may at any time modify the Terms of Use of our Website without any prior notification to you. Should you wish to terminate your account due to a modification to the Terms or the Privacy Policy, you may do so email us at helpdesk@jkshahclasses.com.  However, if you continue to use the service you shall be deemed to have agreed to accept and abide by the modified Terms of this Website.</p>

                            <h5> PRIVILEGED/EXCLUSIVE SERVICE:</h5>
                            <p> By having a JKSC account, you have explicitly given consent for us to capture images (followed by analysis), camera/mic permissions to make video calls and record the same.</p>
                            <h5> JKSC MAY DISCLOSE INFORMATION:</h5>
                            <ul>
                                <li> as required by law, such as to comply with a subpoena, or similar legal process;</li>
                                <li>to enforce applicable ToU (Terms of Use), including investigation of potential violations thereof;
