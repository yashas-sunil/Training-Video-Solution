<div class="modal fade" id="modal-signup" tabindex="-1" role="dialog" aria-labelledby="modal-signup-title"
     aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg modal-signup" role="document">
        <div class="modal-content">
            <div class="modal-header border-0 ">
                <h5 class="modal-title text-secondary  text-uppercase" id="modal-signup-title">SIGN UP</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mt-3 text-center">
                    ...
                    <a id="login" class="text-info" href="#"> Login</a>
                </div>
            </div>
        </div>
    </div>
