                            ...
                            <form id="filter_study_materials" action="" method="GET" >
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm col-md-2">
                                        ...
                                        <input type="number" hidden name="type" value="3" >
                                    </div>
                                    <div class="col-sm col-md-2">
                                ...
                                <div class="table-responsive">
                                    <table class="table mt-3">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-light border-0 font-weight-normal"  scope="col">Answer</th>
                                        ...
                                        @foreach($study_materials['data'] as $study_material)
                                            <tr>
                                                ...
                                                <td>@if ($study_material['answer_file_name']) <a target="_blank" href="{{ $study_material['answer_file_url'] }}">{{ \Illuminate\Support\Str::limit($study_material['answer_file_name'], env('TRIM_SIZE'), $end='...') }}</a>@endif</td>
                                        ...
                                        @else
                                            <div class="mt-4">
                                                <p>Currently there are no test paper !</p>
                                            </div>
                                        @endif
                                        </tbody>
                                    </table>
