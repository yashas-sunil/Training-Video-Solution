...
return [
    ...
    */
    ...
    'testMode'  => env('PAYMENT_TEST_MODE'),                   // True for Testing the Gateway [For production false]

    'ccavenue' => [                         // CCAvenue Parameters
        'merchantId'  => env('INDIPAY_MERCHANT_ID', '245745'),
        'accessCode'  => env('INDIPAY_ACCESS_CODE', 'AVLT90HA04BY39TLYB'),
        'workingKey' => env('INDIPAY_WORKING_KEY', 'F8677030079394D8D35511AC548D85E3'),
    ...
    'easebuzz' => [                         // CCAvenue Parameters
        'merchantkey'  => env('MERCHANT_KEY', '2PBP7IABZ22'),
        'salt'  => env('SALT', 'DAH88E3UWQ2'),
        'env' => env('ENV', 'test'),
    ],
